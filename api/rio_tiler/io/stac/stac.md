...
class STACReader(
    ...
    include_asset_types: Set[str] = {'application/x-hdf', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff', 'image/tiff; application=geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/jp2', 'application/x-hdf5', 'image/x.geotiff'},
